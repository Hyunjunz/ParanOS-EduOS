#!/usr/bin/env bash
# QEMU with AC'97 on SDL audio backend. No sudo; TCG by default.
# Override: QEMU_ACCEL=kvm|tcg, SDL_AUDIODRIVER=pulse|alsa|pipewire
...
qemu-system-x86_64 -m 1024M -machine q35 \
  ...
  -audiodev "sdl,id=aud,out.frequency=48000,out.channels=2" \
